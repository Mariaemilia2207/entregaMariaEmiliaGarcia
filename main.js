...
productos.push (new Producto (1, "Blend", "850"));
productos.push (new Producto (1, "Merlot", "650"));
...
const buscarMabec = productos.find (producto => producto.id === 1);
console.log(buscarMabec);